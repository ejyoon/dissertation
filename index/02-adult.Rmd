# Adults' polite speech predictions reflect competing social goals ^[This chapter is submitted and currently under review at *Open Mind*, and is joint work with Michael Henry Tessler, Noah D. Goodman and Michael C. Frank.]
...
In this Chapter, I present evidence that polite speech emerges from the competition of three communicative goals: to convey information, to be kind, and to present oneself in a good light. 
...
```{r child = 'chapter_child_rmds/ch2_modeling_polite/modeling_polite.Rmd'}
```
