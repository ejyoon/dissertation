...
The rate of children's early lexical development is remarkable. Consider
that children, despite limitations on their processing capabilities and
ambiguity in the input, rapdily acquire new lexical concepts, eventually
reaching an adult vocabulary ranging from 50,000 to 100,000 words (P.
Bloom, 2002). And they accomplish this all while also developing motor
skills, learning social norms, and building causal knowledge. How can we
explain children's prodigious learning abilities?
...
\hypertarget{scope}{\section{Part I: Learning from others vs.~lrearning
from others}\label{scope}}
...
and ``social'' have become associated with several different
definitions. So before reviewing the empirical evidence for each
account, it is worth defining what we mean when by active learning and
by social contexts. By providing these definitions, this section aims to
clarify the behaviors that the integrative account attempts to explain.
...
In the integrative account, I focus on active learning effects that
...
2009; Goodman \& Frank, 2016; Shafto, Eaves, Navarro, \& Perfors,
2012a). These parallel formalizations suggest a way ot integrate active
and social learning theories. This point is the primary focus of the
integative account that I present in
\protect\hyperlink{active_social}{Part III} of this chapter. Before
discussing the details of the account, I provide a brief overview of the
OED formalization.
