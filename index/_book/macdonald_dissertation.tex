...
section, I discuss the ways that social contexts can affect each
...
rule -- search until I find the definitions that I need. The function of
a stopping rule is to balance information gained with reducing
...
you get sick?'' ADULT: ``I don't know.'') (see also Deborah, Louisa
...
Our work on children's decisions eye movements during real-time language
comprehension is also relevant to stopping decisions (MacDonald et al.,
2018). We found that both adults and children chose to allocate more
visual fixations to a speaker's face while processing speech in noisy
auditory environments, a delay that resulted in more initial gaze shifts
to the named referent in the visual world. We used a threshold decision
making model (Drift Diffusion Model Ratcliff \& McKoon (2008)) to
provide evidence that the behavioral differences were caused by a
increased in listeners' decision thresholds and not by changes in
processsing efficiency (i.e., the amount of information gained per unit
time). This approach provides an example of bringing cognitive models of
decision making into contact with empirical questions about how socially
grounded ingteractions could influence children's language processing.
