...
\centering
\resizebox{\linewidth}{!}{
\begin{tabular}{llll>{\raggedright\arraybackslash}p{2.5cm}>{\raggedright\arraybackslash}p{2.5cm}}
\toprule
\textbf{Condition} & \textbf{Sample} & \textbf{Age group} & \textbf{N} & \textbf{Mean age (years)} & \textbf{SD age (years)}\\
\midrule
Control (no reason for dishonesty) & original & 5-6-yr & 26 & 5.92 & 0.45\\
Control (no reason for dishonesty) & original & 7-8-yr & 19 & 7.94 & 0.59\\
Control (no reason for dishonesty) & original & adult & 76 &  & \\
Control (no reason for dishonesty) & replication & 5-6-yr & 33 & 5.98 & 0.58\\
Control (no reason for dishonesty) & replication & 7-8-yr & 31 & 7.91 & 0.56\\
\addlinespace
Experimental (politeness reasons) & original & 5-6-yr & 24 & 5.99 & 0.69\\
Experimental (politeness reasons) & original & 7-8-yr & 18 & 8.08 & 0.69\\
Experimental (politeness reasons) & original & adult & 71 &  & \\
Experimental (politeness reasons) & replication & 5-6-yr & 33 & 5.98 & 0.58\\
Experimental (politeness reasons) & replication & 7-8-yr & 31 & 7.91 & 0.56\\
\bottomrule
\end{tabular}}
\end{table}
...
\caption{FIXME.}\label{fig:figTrupolResultsPlacement}
\end{figure*}
