...
information transfer (e.g., Bühler, 1934; N. D. Goodman \& Stuhlmuller,
...
\caption{\label{tab:childInfSample}Participant demographic information.}
\begin{tabular}{llll}
\toprule
Condition & \multicolumn{1}{c}{Sample} & \multicolumn{1}{c}{Age group} & \multicolumn{1}{c}{Number of participants}\\
\midrule
Control (no reason for dishonesty) & original & 5-6-yr & 26.00\\
Control (no reason for dishonesty) & original & 7-8-yr & 19.00\\
Control (no reason for dishonesty) & original & adult & 76.00\\
Control (no reason for dishonesty) & replication & 5-6-yr & 33.00\\
Control (no reason for dishonesty) & replication & 7-8-yr & 31.00\\
Experimental (politeness reasons) & original & 5-6-yr & 24.00\\
Experimental (politeness reasons) & original & 7-8-yr & 18.00\\
Experimental (politeness reasons) & original & adult & 71.00\\
Experimental (politeness reasons) & replication & 5-6-yr & 33.00\\
Experimental (politeness reasons) & replication & 7-8-yr & 31.00\\
\bottomrule
\end{tabular}
\end{threeparttable}
\end{center}
...
\(\lambda_{S_2}\); N. D. Goodman \& Stuhlmuller, 2013):
