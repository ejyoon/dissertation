...
\end{figure}
\begin{center}\includegraphics[width=0.9\linewidth]{erica_yoon_dissertation_files/figure-latex/comparisonAllPlot-1} \end{center}
\begin{figure}[!h]
...
\end{figure}
\begin{center}\includegraphics[width=0.9\linewidth]{erica_yoon_dissertation_files/figure-latex/negation-1} \end{center}
\begin{figure}[!h]
