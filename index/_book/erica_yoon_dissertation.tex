...
\caption[Participant demographic information]{\label{tab:childInfSample}Participant demographic information.}
\centering
\resizebox{\linewidth}{!}{
...
\caption[Graphical representation of the computational model.]{Diagram of the model: The polite speaker observes the true state and determines her goal between three utilities (informational, social, and presentational), and produces an utterance.}\label{fig:model}
\end{figure}
