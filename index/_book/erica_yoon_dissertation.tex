...
production of polite speech in adults and children. Then I present two
sets of empirical studies looking at the development of polite language
understanding in children: 2- to 4-year-old children's judgments for
polite requests (Chapter 2) and 5- to 8-year-old children's judgments
for polite lies versus blunt truths (Chapter 3). In Chapter 4, I examine
adults' understanding of polite speech: I present a computational model
that formalizes the notion of goals as utilities that speakers try to
maximize through language use, and show that this model successfully
captures adults' predictions and judgments for polite lies and indirect
speech. Overall, the work presented in this thesis reveals how
children's and adults' understanding of polite speech reflects their
understanding of speakers' different social goals and tradeoffs between
them.
...
(Erica J. Yoon, Tessler, Goodman, \& Frank, 2017).
...
truths). We show that 5- to 8-year-old children understand that the same
...
or simply misleading without any reason.
...
to be better play partners (Erica J. Yoon \& Frank, 2019).

Do children think of the goals to be informative and to be kind as
...
approach to language. They may think about deterministic rules such as
``If you want something, then you should say \emph{please}'' and ``If
you see/feel/think \emph{X}, then you should (truthfully) say
\emph{X.}'' Children can use these rules to both produce polite and
truthful utterances themselves, and evaluate speakers based on whether
they follow these rules or not (``She is nice because she said
...
First, do children \emph{say} things that are truthful yet kind? From
early on, children start producing prosocial lies. There is evidence
that by 3 years, children start to tell white lies, and e.g., say that
an adult ``looks okay for the picture'' even though she has a
conspicuous mark of lipstick on her nose (Talwar \& Lee, 2002), or lie
to a gift-giver about her gift that they actually found undesirable
(Talwar et al., 2007).
...
\midrule
Intercept & -2.02 & 2.88 & -8.64 & 4.34\\
Experimental condition (Expt) & 1.39 & 3.27 & -5.04 & 8.29\\
Meanness question (Mean) & 3.63 & 3.98 & -5.70 & 11.79\\
Kindness question (Kind) & 5.50 & 3.65 & -1.92 & 13.01\\
Dishonest speaker (Dishonest) & 2.16 & 3.32 & -4.36 & 10.28\\
Age & 0.87 & 0.26 & 0.37 & 1.41\\
Expt * Mean & -2.72 & 0.42 & -3.56 & -1.91\\
Expt * Nice & -1.28 & 0.55 & -2.34 & -0.20\\
Expt * Dishonest & -1.65 & 0.37 & -2.39 & -0.94\\
Mean * Dishonest & -4.14 & 0.41 & -4.97 & -3.36\\
Nice * Dishonest & -8.39 & 0.65 & -9.72 & -7.20\\
Expt * Age & -0.32 & 0.29 & -0.90 & 0.24\\
Mean * Age & -1.68 & 0.40 & -2.47 & -0.92\\
Nice * Age & -0.52 & 0.47 & -1.44 & 0.38\\
Dishonest * Age & -0.71 & 0.28 & -1.25 & -0.17\\
Expt * Mean * Dishonest & 3.69 & 0.51 & 2.71 & 4.72\\
Expt * Nice * Dishonest & 1.37 & 0.72 & -0.06 & 2.80\\
Expt * Mean * Age & 0.74 & 0.42 & -0.07 & 1.57\\
Expt * Nice * Age & 0.81 & 0.56 & -0.26 & 1.92\\
Expt * Dishonest * Age & 0.03 & 0.37 & -0.69 & 0.76\\
Mean * Dishonest * Age & 1.46 & 0.39 & 0.73 & 2.23\\
Nice * Dishonest * Age & -0.28 & 0.54 & -1.39 & 0.76\\
Expt * Mean * Dishonest * Age & -0.30 & 0.51 & -1.31 & 0.69\\
Expt * Nice * Dishonest * Age & -1.31 & 0.75 & -2.78 & 0.12\\
\bottomrule
\end{tabular}
\end{threeparttable}
\end{center}
...
Figure~\ref{fig:figTrupolResultsPlacement}. For statistical analysis, we
used a Bayesian linear mixed-effects model (\texttt{brms} package in R;
...
Thus, children were able to evaluate the dishonest speaker's intentions
differently based on the context.

There was also a positive interaction between participant age, dishonest
speaker and niceness judgment, which shows that children judged the
dishonest speaker as nice more often with increasing age, a trend that
extended to adulthood (Figure~\ref{fig:figTrupolResultsPlacement}). Why
did adults and older children judge the dishonest speaker more favorably
compared to younger children? One possible explanation is older children
are more proficient at inferring other people's mental states (Wellman
\& Liu, 2004), leading them to place more weight on the addressee's
feelings in evaluating a white lie or blunt truth. Another possibility
...
Finally, there was a positive interaction between dishonest speaker and
meanness rating, which indicates that a dishonest speaker was rated as
mean more often compared to the honest speaker overall.
...
positively whereas younger participants tended to be divided. We think
this age difference may be due to a discrepancy in goal priorities:
Younger children may prioritize truth-telling, which can be a simple
rule to follow (e.g., ``Don't lie, always tell the truth'') but as they
get older, they might learn to consider other people's feelings and
address the informational-social tradeoff more.
...
tracking of second-order beliefs, etc.). Future work should think of
possible follow-up task that is more accessible for younger children and
can test their understanding of goal tradeoffs.
...
that they can make the machine work for sure; Erica J Yoon, MacDonald,
Asaba, Gweon, \& Frank, 2018). Thus, future work should investigate how
