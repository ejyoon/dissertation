...
Thus, children were able to evaluate the dishonest speaker's intentions differently based on the context.

There was also a positive interaction between participant age, dishonest speaker and niceness judgment, which shows that children judged the dishonest speaker as nice more often with increasing age, a trend that extended to adulthood (Figure\ \ref{fig:figTrupolResultsPlacement}). 
...
Finally, there was a positive interaction between dishonest speaker and meanness rating, which indicates that a dishonest speaker was rated as mean more often compared to the honest speaker overall. 
