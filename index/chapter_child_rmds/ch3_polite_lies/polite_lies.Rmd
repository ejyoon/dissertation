...
```{r figTrupolLfeelResultsPlacement, fig.env = "figure*", fig.pos = "t", fig.width=7, fig.height=4, fig.align = "center", set.cap.width=T, num.cols.cap=2, fig.cap = "Children's ratings of listener feelings (y-axis) upon hearing the utterance of the honest versus dishonest speaker (columns), across age (x-axis)."}
