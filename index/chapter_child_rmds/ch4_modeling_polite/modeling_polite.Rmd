...
```{r model, fig.cap="Diagram of the model: The polite speaker observes the true state and determines her goal between three utilities (informational, social, and presentational), and produces an utterance.", fig.scap = "Graphical representation of the computational model."}
...
```{r variance, echo=FALSE, fig.cap="Full distribution of human responses vs. model predictions. Error bars represent 95\\% confidence intervals for the data (vertical) and 95\\% highest density intervals for the model (horizontal).", fig.scap="Comparison between human responses and model predictions."}
ms_var <- ms_utt %>%
