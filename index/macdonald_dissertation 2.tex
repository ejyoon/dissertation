...
(Chapters 4 and 5). The upshot of the empirical work is that children's
information seeking is quite flexible, providing support for language
processing by gathering useful information from communicative partners.
...
has been my greatest advocate. Thank you for your patience, kindness,
...
\& Schwade, 2008). ({\textbf{???}}) propose that social input was
particularly useful because the responses were closer in time, making it
easier for children to compare any discrepancies between their
...
that I present in \protect\hyperlink{active_social}{Part III} of this
...
Bloom, 2002; E. V. Clark, 2009; Hollich et al., 2000). Some of our
